...
class k_cluster:
    ...
    def _find_exposures(self):
        ...
        print(f"df includes NaN values: {signatures.isna().any().any()}")
        print(f"samples={self.dataset}")
        print(f"output={self.output_path}/output_weights")
        print(f"signature_database: {self.output_path}/signatures.tsv")
