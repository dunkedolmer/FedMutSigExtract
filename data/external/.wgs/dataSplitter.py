...
def split_by_columns(source_file, num_files):
    ...
    output_dir = 'data/external/sample8/uneven'
    ...
    for i in range(num_files):
        ...
        output_file = os.path.join(output_dir, f'file_{i+1}.{ext_type}')
        # output_file = os.path.join(output_dir, f'weights_{i+1}.{ext_type}')
...
if __name__ == "__main__":
    ...
    source_file = os.path.join(current_dir, 'WGS_PCAWG.96.csv')
    print(f"Splitting file: {source_file}")
    num_files = 3
    ...
    split_by_columns_percentage(source_file, num_files, [926,926,926])